...
export function LandlordBrowse() {
  ...
  const summaryCards = [
    ...
    { label: "Average Rent", value: `₱${marketInsights.averageRent.toLocaleString("en-PH")}`, detail: "Available-room monthly rent", icon: TrendingUp, tone: "bg-violet-50 text-violet-600" },
