...
import { Heart, Menu, User, LogOut, LayoutDashboard, Settings, Palette, Shield } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          <Link to={isAuthenticated ? "/dashboard" : "/"} className="flex items-center space-x-2 group">
            <AppLogo className="h-10 w-10 rounded-xl transition-all duration-300 group-hover:scale-105" />
            <span className="text-xl font-semibold bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">AptFindr</span>
          </Link>
